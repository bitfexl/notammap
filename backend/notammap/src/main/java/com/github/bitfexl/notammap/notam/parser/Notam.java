...
public class Notam {
    ...
    // Jackson lowercases all leading uppercase characters when using getters
    // so the lombok autogenerated getQLower and getQUpper break the casing of qLower and qUpper (qlower and qupper)
    public Integer getqLower() {
        return qLower;
    }
    public Integer getqUpper() {
        return qUpper;
    }
    ...
    public boolean hasSpecificHeightInformation() {
        return raw != null && qLower != 0 && qUpper != 999;
    }
